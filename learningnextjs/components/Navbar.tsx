  ...
  return (
    <nav className=' max-w-[20vw] min-w-[20vw]  h-screen px-4 py-4 flex border-r border-gray-400  gap-3 flex-col ' >
        ...
        <div className='flex gap-2 flex-col ' >
            ...
            <Link className = { pathname ==  "/ipl/PointsTable" ? "px-2 py-2  rounded-xl bg-blue-300 transition-all text-gray-700" : 'px-2 py-2  rounded-xl hover:bg-blue-300 transition-all hover:text-gray-700  ' } href = "/ipl/PointsTable">IPL</Link>
        </div>
